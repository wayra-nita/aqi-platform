...
use Ya\CoreModelBundle\Form\EventListener\ReplaceNotSubmittedValuesByDefaultsListener;
...
class PaginationType extends AbstractType
{
  ...
  public function setDefaultOptions(OptionsResolverInterface $resolver)
  {
    $resolver->setDefaults(array(
      ...
      'data_class' => 'Ya\\CoreModelBundle\\Form\\Model\\Pagination',
    ));
  }
